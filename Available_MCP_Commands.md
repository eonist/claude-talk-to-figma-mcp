...
```json
[
  { "id": "0:1", "name": "Page 1", "childCount": 5 },
  { "id": "1:1", "name": "Page 2", "childCount": 3 }
]
```
...
**Parameters:**
- pageId (string): The ID of the page to set as current
...
**Parameters:**
- name (string, optional): The name for the new page. Default is "New Page".
