...
**Parameters:**
- \`instanceId\` (string, required): **Instance ID**. Required. The unique Figma instance ID to detach. Must be a string in the format '123:456' or a complex instance ID like 'I422:10713;1082:2236'. Example: "123:456"
